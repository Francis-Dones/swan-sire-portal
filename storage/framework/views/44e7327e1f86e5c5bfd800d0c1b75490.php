...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Ship Inspection Portal'); ?></title>
...
<div class="flex h-full">
    ...
    <aside class="fixed md:sticky top-0 left-0 h-screen z-50 md:z-auto
        ...
        <nav class="flex-1 px-3 py-3">
            ...
            <a href="<?php echo e(route('images.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('images*') ? 'active' : ''); ?>"
               @click="if(!isDesktop) sidebarOpen = false">
            ...
            <a href="<?php echo e(route('exams.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('exams*') ? 'active' : ''); ?>"
               @click="if(!isDesktop) sidebarOpen = false">
                <span class="nav-icon"><i class="ti ti-clipboard-list"></i></span>
                <span>BIQ</span>
            </a>

            <a href="<?php echo e(route('vessels.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('vessels*') ? 'active' : ''); ?>"
               @click="if(!isDesktop) sidebarOpen = false">
            ...
            <div class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-700/50">
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-sm font-semibold text-gray-800 dark:text-gray-200 truncate leading-tight">
                        <?php echo e(session('user_name', auth()->user()->username ?? 'User')); ?>

                    </p>
                    <p class="text-gray-400 truncate leading-tight" style="font-size:11px;">
                        <?php echo e(session('user_email', auth()->user()->email ?? 'Logged in')); ?>
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)"
            ...
            <span class="flex items-center gap-2"><i class="ti ti-check-circle text-lg"></i> <?php echo e(session('success')); ?></span>
        ...
        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)"
            ...
            <span class="flex items-center gap-2"><i class="ti ti-alert-circle text-lg"></i> <?php echo e(session('error')); ?></span>
...
</html><?php /**PATH C:\xampp\htdocs\ship-inspection-portal\resources\views/layouts/app.blade.php ENDPATH**/ ?>