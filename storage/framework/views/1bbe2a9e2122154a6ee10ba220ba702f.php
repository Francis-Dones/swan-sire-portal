...
<div class="container mx-auto px-4 py-6">
    <a href="<?php echo e(route('images.index')); ?>" class="text-blue-500 hover:underline mb-4 inline-flex items-center gap-2">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div x-data="{ 
                    ...
                    downloadImage(base64Data, fileName) {
                     ...
                     x-init="() => {
                         fetch('<?php echo e(route('images.data', $imageId)); ?>')
                             .then(res => res.json())
                             .then(data => {
                    ...
                    <div class="relative">
                        <template x-if="loaded && imgData">
                            <div>
                                <img :src="'data:image/jpeg;base64,' + imgData" 
                                     alt="<?php echo e($image['image_name'] ?? $image['name'] ?? 'Image'); ?>"
                                     class="w-full rounded-lg shadow-md"
                                     id="detailImage">
                                
                                <!-- Download Button Overlay -->
                                <button @click="downloadImage(imgData, '<?php echo e($image['image_name'] ?? $image['name'] ?? 'image'); ?>')" 
                        ...
                        <template x-if="error">
                            <div class="bg-gray-100 dark:bg-gray-700 h-96 flex flex-col items-center justify-center rounded-lg">
                                ...
                                <p class="text-xs text-gray-400 mt-1">Image ID: <?php echo e($imageId); ?></p>
                                ...
                                <div class="mt-4 p-4 bg-gray-200 dark:bg-gray-600 rounded text-xs text-left w-full max-w-md">
                                    ...
                                    <p>Image ID: <?php echo e($imageId); ?></p>
                                    <p>Available keys: <?php echo e(implode(', ', array_keys($image))); ?></p>
                                    <p>Has image_data: <?php echo e(isset($image['image_data']) ? 'Yes (length: ' . strlen($image['image_data']) . ')' : 'No'); ?></p>
                                    <p>Has base64_image: <?php echo e(isset($image['base64_image']) ? 'Yes' : 'No'); ?></p>
                                    <p>Has image: <?php echo e(isset($image['image']) ? 'Yes' : 'No'); ?></p>
                                </div>
                                <?php endif; ?>
                            </div>
                        </template>
            ...
            <div>
                <h2 class="text-xl font-bold mb-4 flex items-center gap-2">
                    ...
                    <?php echo e($image['image_name'] ?? $image['name'] ?? 'Image Details'); ?>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <dd class="font-medium"><?php echo e($image['vessel_name'] ?? $image['vesselName'] ?? $image['vessel']['name'] ?? 'N/A'); ?></dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <dd class="font-medium"><?php echo e($image['vessel_id'] ?? $image['vesselId'] ?? $image['vessel']['id'] ?? 'N/A'); ?></dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <dd class="font-medium"><?php echo e($image['inspection_id'] ?? $image['inspectionId'] ?? 'N/A'); ?></dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <dd class="font-medium"><?php echo e($image['inspection_loc'] ?? $image['inspectionLoc'] ?? $image['location'] ?? 'N/A'); ?></dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <dd class="font-medium"><?php echo e($image['inspector_name'] ?? $image['inspectorName'] ?? $image['inspector']['name'] ?? 'N/A'); ?></dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <dd>
                                <?php if(!empty($image['inspection_type']) || !empty($image['inspectionType'])): ?>
                                <span class="bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-sm">
                                    <?php echo e($image['inspection_type'] ?? $image['inspectionType']); ?>
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <dd class="font-medium"><?php echo e($image['remarks'] ?? 'N/A'); ?></dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <dd class="font-medium text-sm text-gray-500"><?php echo e($image['id'] ?? $image['image_id'] ?? 'N/A'); ?></dd>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 pt-4 border-t flex flex-wrap gap-3">
                            ...
                            fetch('<?php echo e(route('images.data', $imageId)); ?>')
                                ...
                                .then(data => {
                                    if (data.success && data.image_data) {
                                        ...
                                        link.download = '<?php echo e($image['image_name'] ?? $image['name'] ?? 'image'); ?>.jpg';
                                        document.body.appendChild(link);
                                        link.click();
                                        document.body.removeChild(link);
                                    } else {
                    ...
                    <form action="<?php echo e(route('images.destroy', $image['id'] ?? $image['image_id'] ?? 0)); ?>" 
                          method="POST" 
                          class="inline"
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
        ...
        <a href="<?php echo e(route('images.index')); ?>" class="mt-4 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
            Back to Images
        </a>
    </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ship-inspection-portal\resources\views/images/show.blade.php ENDPATH**/ ?>